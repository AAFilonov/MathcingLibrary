...
// Аналогичен алгоритму из TwoStepAllocator, но итерация разделена на несколько шагов вызываемых независимо
...
// предпочтения более поздних итераций противоречить более ранним. Кроме того отличием является поведение в некоторых угловых случаях,
